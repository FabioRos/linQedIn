...
//    layout_top->addWidget(lbl_hint_inserimento,riga_fine_competenze+2,1,1,3);
...
void client_profilo::aggiungi_competenza(){
    ...
    disabilita_tutto();
    abilita_modifiche();
    //devo fare client_enviroment::scroll_area->adjustSize();
}
...
void client_profilo::popola_blocco_competenze()
{
...
void client_profilo::popola() {
    ...
    layout_top->addWidget(nome,0,1,1,2);
    layout_top->addWidget(lbl_cognome,1,0);
    layout_top->addWidget(cognome,1,1,1,2);
    layout_top->addWidget(lbl_username,2,0);
    layout_top->addWidget(username,2,1,1,2);
    layout_top->addWidget(btn_modifica_profilo,0,3);
