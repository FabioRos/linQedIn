...
# Generated by qmake (2.01a) (Qt 4.8.6) on: sab gen 3 12:13:27 2015
...
SOURCES       = attivita.cpp \
		...
		VIEW/amministazione.cpp moc_finestraprincipale.cpp \
		moc_amministazione.cpp
OBJECTS       = attivita.o \
		data.o \
		db.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/LinQedIn1.0.0/ && $(COPY_FILE) --parents attivita.h data.h db.h esperienza_professionale.h finestraprincipale.h lingua.h rete.h smart_utente.h titolo_di_studio.h utente.h utente_a_pagamento.h utente_basic.h utente_business.h utente_executive.h utente_gratis.h TEST/test.h TEST/test_data.h TEST/test_esperienza.h TEST/test_lingua.h TEST/test_manager.h TEST/test_utente_basic.h VIEW/amministazione.h .tmp/LinQedIn1.0.0/ && $(COPY_FILE) --parents attivita.cpp data.cpp db.cpp esperienza_professionale.cpp finestraprincipale.cpp lingua.cpp main.cpp rete.cpp smart_utente.cpp titolo_di_studio.cpp utente.cpp utente_a_pagamento.cpp utente_basic.cpp utente_business.cpp utente_executive.cpp utente_gratis.cpp TEST/test.cpp TEST/test_data.cpp TEST/test_esperienza.cpp TEST/test_lingua.cpp TEST/test_manager.cpp TEST/test_utente_basic.cpp VIEW/amministazione.cpp .tmp/LinQedIn1.0.0/ && (cd `dirname .tmp/LinQedIn1.0.0` && $(TAR) LinQedIn1.0.0.tar LinQedIn1.0.0 && $(COMPRESS) LinQedIn1.0.0.tar) && $(MOVE) `dirname .tmp/LinQedIn1.0.0`/LinQedIn1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/LinQedIn1.0.0
...
compiler_moc_header_make_all: moc_finestraprincipale.cpp moc_amministazione.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_finestraprincipale.cpp moc_amministazione.cpp
moc_finestraprincipale.cpp: VIEW/amministazione.h \
...
moc_amministazione.cpp: VIEW/amministazione.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) VIEW/amministazione.h -o moc_amministazione.cpp
...
amministazione.o: VIEW/amministazione.cpp VIEW/amministazione.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o amministazione.o VIEW/amministazione.cpp
...
moc_amministazione.o: moc_amministazione.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_amministazione.o moc_amministazione.cpp
